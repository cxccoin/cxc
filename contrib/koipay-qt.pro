...
RESOURCES += src/qt/koipay.qrc src/qt/koipay_locale.qrc

TRANSLATIONS += src/qt/locale/koipay_bg.ts \
                src/qt/locale/koipay_de.ts \
                src/qt/locale/koipay_en.ts \
                src/qt/locale/koipay_es.ts \
                src/qt/locale/koipay_fi.ts \
                src/qt/locale/koipay_fr.ts \
                src/qt/locale/koipay_it.ts \
                src/qt/locale/koipay_ja.ts \
                src/qt/locale/koipay_pl.ts \
                src/qt/locale/koipay_pt.ts \
                src/qt/locale/koipay_ru.ts \
                src/qt/locale/koipay_sk.ts \
                src/qt/locale/koipay_sv.ts \
                src/qt/locale/koipay_vi.ts \
                src/qt/locale/koipay_zh_CN.ts \
                src/qt/locale/koipay_zh_TW.ts

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KoiPay features */
        {"koipay", "masternode", &masternode, true, true, false},
        {"koipay", "listmasternodes", &listmasternodes, true, true, false},
        {"koipay", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"koipay", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"koipay", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"koipay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"koipay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"koipay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"koipay", "masternodedebug", &masternodedebug, true, true, false},
        {"koipay", "startmasternode", &startmasternode, true, true, false},
        {"koipay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"koipay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"koipay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"koipay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"koipay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"koipay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"koipay", "mnbudget", &mnbudget, true, true, false},
        {"koipay", "preparebudget", &preparebudget, true, true, false},
        {"koipay", "submitbudget", &submitbudget, true, true, false},
        {"koipay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"koipay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"koipay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"koipay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"koipay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"koipay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"koipay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"koipay", "checkbudgets", &checkbudgets, true, true, false},
        {"koipay", "mnsync", &mnsync, true, true, false},
        {"koipay", "spork", &spork, true, true, false},
        {"koipay", "getpoolinfo", &getpoolinfo, true, true, false},
        {"koipay", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> koipay-cli " + methodname + " " + args + "\n";
}

...
{
public:
    /// Is the inputs associated with this public key? (and there is 500000 CXC - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of koipay.

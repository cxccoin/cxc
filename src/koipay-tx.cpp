...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KoiPay Core koipay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  koipay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded koipay transaction") + "\n" +
                               "  koipay-tx [options] -create [commands]   " + _("Create hex-encoded koipay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded koipay transaction

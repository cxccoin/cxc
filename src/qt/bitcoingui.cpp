                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KoiPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KoiPay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and koipay: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KoiPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about KoiPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KoiPay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KoiPay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KoiPay addresses"));
    ...
    openAction->setStatusTip(tr("Open a KoiPay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KoiPay Core help message to get a list with possible KoiPay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KoiPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KoiPay network", "", count));
}
...
{
    QString strTitle = tr("KoiPay Core"); // default title

...
/** Utility functions used by the KoiPay Qt UI.
 */
namespace GUIUtil
{
...
// Render KoiPay addresses in monospace font
...
// Parse "koipay:" URI into recipient object, return true on successful parsing

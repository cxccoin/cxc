...
public:
    ...
    QSize minimumSizeHint() const
    {
        if (cachedMinimumSizeHint.isEmpty()) {
            ...
            int w = fm.width(BitcoinUnits::format(BitcoinUnits::CXC, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
...
private:
    ...
    /**
     * Parse a string into a number of base koipay units and
     * return validity.

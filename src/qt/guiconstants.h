...
/* KoiPay GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "KoiPay"
#define QAPP_ORG_DOMAIN "koipay.org"
#define QAPP_APP_NAME_DEFAULT "KoiPay-Qt"
#define QAPP_APP_NAME_TESTNET "KoiPay-Qt-testnet"

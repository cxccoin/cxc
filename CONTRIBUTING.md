Contributing to KoiPay Core
============================

The KoiPay Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KoiPay Core project, and is not to be
confused with overall KoiPay Network Protocol consensus changes.

Whether a pull request is merged into KoiPay Core rests with the project merge
...
Patches that change KoiPay consensus rules are considerably more involved than
...
Where a patch set proposes to change the KoiPay consensus, it must have been
...
The project leader is the release manager for each KoiPay Core release.

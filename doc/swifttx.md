...
This mechanism has been integrated into Bitcore-Node-KoiPay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/koipayproject/insight-api-koipay#web-socket-api](https://github.com/koipayproject/insight-api-koipay#web-socket-api) 
* API: [https://github.com/koipayproject/insight-api-koipay#swifttx-transactions](https://github.com/koipayproject/insight-api-koipay#swifttx-transactions) 
...
By default, the KoiPay Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the KoiPay Core daemon:

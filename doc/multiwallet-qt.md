...
In order to support loading of multiple wallets in koipay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is koipay.cpp.
...
Changes to koipay.cpp
----------------------
koipay.cpp is the entry point into koipay-qt, and as such, will require some minor modifications to provide hooks for

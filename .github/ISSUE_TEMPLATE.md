...
This issue tracker is only for technical issues related to KoiPay Core.
General KoiPay questions and/or support requests and are best directed to the [KoiPay Discord](https://discord.gg/sbgdcdv).
...
### What version of KoiPay Core are you using?
